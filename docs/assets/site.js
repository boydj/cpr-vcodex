(() => {
  ...
  const messages = {
    en: {
      ...
      homeSubtitle: "Small browser tools for CPR-vCodex on the Xteink X4, X3 and X4 Pro. Everything runs locally in your browser.",
      latestFirmware: "Latest firmware: 1.6.0.1-cpr-vcodex",
      ...
      flashSubtitle: "Install the latest CPR-vCodex firmware on your Xteink X4, X3 or X4 Pro from Chrome or Edge using Web Serial. It writes the inactive app partition and then switches boot to it.",
      ...
      cableText: "Connect the Xteink to your computer. If no serial port appears, wake and unlock the device, then reconnect it. On the X4 Pro, unplug and replug the cable and hold Power if the port does not show up.",
      browserTitle: "Use Chrome or Edge on desktop",
      browserText: "Firefox and Safari do not support Web Serial. The browser will ask you to choose the Xteink USB serial port (ESP32-C3 on the X4 and X3, ESP32-S3 on the X4 Pro).",
      ...
      deviceModelText: "Choose the exact model before flashing. X3 and X4 share one ESP32-C3 image with different OTA slot sizes; the X4 Pro is an ESP32-S3 with its own firmware. The page checks the connected chip before writing.",
      deviceX4: "Xteink X4",
      deviceX3: "Xteink X3",
      deviceX4Pro: "Xteink X4 Pro",
      deviceX4Slot: "ESP32-C3 · 6.4 MB OTA slot",
      deviceX3Slot: "ESP32-C3 · 7.4 MB OTA slot",
      deviceX4ProSlot: "ESP32-S3 · 8.2 MB OTA slot",
      deviceX4ProNote: "X4 Pro: the ESP32-S3 cannot be reset over USB serial. After the flash finishes, unplug the USB cable, plug it back in, then hold Power until the device boots.",
      firmwareUnavailableForDevice: "No {chip} firmware for the {device} is published in this release yet. Flashing is disabled until a release ships that asset.",
      firmwareNotPublished: "Not published ({chip})",
      ...
      choosePort: "Choose the {chip} serial port of your {device} in the browser prompt.",
      openingConnection: "Opening bootloader connection...",
      chipDetected: "Connected chip: {chip}.",
      chipMismatch: "Connected chip is {detected}, but {device} uses {expected}. Select the matching device model and try again. Nothing was written.",
      ...
      flashCompleteX4Pro: "Flash complete. The X4 Pro cannot be reset over serial: unplug the USB cable, plug it back in, then hold Power until CPR-vCodex boots.",
      resetManualX4Pro: "Manual reset required on the X4 Pro: unplug and replug USB, then hold Power.",
    ...
    es: {
      ...
      homeSubtitle: "Pequeñas herramientas de navegador para CPR-vCodex en Xteink X4, X3 y X4 Pro. Todo se ejecuta localmente en tu navegador.",
      latestFirmware: "Último firmware: 1.6.0.1-cpr-vcodex",
      homeFlash: "Auto Flash",
      ...
      flashSubtitle: "Instala el último firmware CPR-vCodex en tu Xteink X4, X3 o X4 Pro desde Chrome o Edge usando Web Serial. Escribe la partición de app inactiva y luego arranca desde ella.",
      ...
      cableText: "Conecta el Xteink al ordenador. Si no aparece el puerto serie, despierta y desbloquea el dispositivo y vuelve a conectarlo. En el X4 Pro, desconecta y vuelve a conectar el cable y mantén pulsado Power si el puerto no aparece.",
      browserTitle: "Usa Chrome o Edge en escritorio",
      browserText: "Firefox y Safari no soportan Web Serial. El navegador te pedirá elegir el puerto USB serie del Xteink (ESP32-C3 en X4 y X3, ESP32-S3 en X4 Pro).",
      ...
      deviceModelText: "Elige el modelo exacto antes de flashear. X3 y X4 comparten una imagen ESP32-C3 con slots OTA de distinto tamaño; el X4 Pro es un ESP32-S3 con su propio firmware. La página comprueba el chip conectado antes de escribir.",
      deviceX4: "Xteink X4",
      deviceX3: "Xteink X3",
      deviceX4Pro: "Xteink X4 Pro",
      deviceX4Slot: "ESP32-C3 · slot OTA de 6,4 MB",
      deviceX3Slot: "ESP32-C3 · slot OTA de 7,4 MB",
      deviceX4ProSlot: "ESP32-S3 · slot OTA de 8,2 MB",
      deviceX4ProNote: "X4 Pro: el ESP32-S3 no se puede reiniciar por USB serie. Cuando termine el flasheo, desconecta el cable USB, vuelve a conectarlo y mantén pulsado Power hasta que arranque.",
      firmwareUnavailableForDevice: "Esta release aún no publica firmware {chip} para el {device}. El flasheo queda desactivado hasta que una release incluya ese asset.",
      firmwareNotPublished: "No publicado ({chip})",
      ...
      choosePort: "Elige el puerto serie {chip} de tu {device} en el aviso del navegador.",
      openingConnection: "Abriendo conexión con el bootloader...",
      chipDetected: "Chip conectado: {chip}.",
      chipMismatch: "El chip conectado es {detected}, pero {device} usa {expected}. Elige el modelo de dispositivo correcto y vuelve a intentarlo. No se ha escrito nada.",
      ...
      flashCompleteX4Pro: "Flasheo completado. El X4 Pro no se puede reiniciar por serie: desconecta el cable USB, vuelve a conectarlo y mantén pulsado Power hasta que arranque CPR-vCodex.",
      resetManualX4Pro: "Reinicio manual necesario en el X4 Pro: desconecta y vuelve a conectar el USB y mantén pulsado Power.",
  ...
  Object.assign(messages, {
    ca: {
      ...
      homeSubtitle: "Petites eines de navegador per a CPR-vCodex. Tot s'executa localment al navegador.", latestFirmware: "Últim firmware: 1.6.0.1-cpr-vcodex", homeStats: "Editor d'estadístiques",
    ...
    fr: {
      ...
      homeSubtitle: "Petits outils de navigateur pour CPR-vCodex. Tout s'exécute localement dans votre navigateur.", latestFirmware: "Dernier firmware : 1.6.0.1-cpr-vcodex", homeStats: "Éditeur de statistiques",
    ...
    de: {
      ...
      homeSubtitle: "Kleine Browser-Tools für CPR-vCodex. Alles läuft lokal in Ihrem Browser.", latestFirmware: "Neueste Firmware: 1.6.0.1-cpr-vcodex", homeStats: "Statistik-Editor",
    ...
    it: {
      ...
      homeSubtitle: "Piccoli strumenti browser per CPR-vCodex. Tutto viene eseguito localmente nel browser.", latestFirmware: "Firmware più recente: 1.6.0.1-cpr-vcodex", homeStats: "Editor statistiche",
    ...
    pt: {
      ...
      homeSubtitle: "Pequenas ferramentas de navegador para CPR-vCodex. Tudo roda localmente no seu navegador.", latestFirmware: "Firmware mais recente: 1.6.0.1-cpr-vcodex", homeStats: "Editor de estatísticas",
    ...
    nl: {
      ...
      homeSubtitle: "Kleine browsertools voor CPR-vCodex. Alles draait lokaal in je browser.", latestFirmware: "Nieuwste firmware: 1.6.0.1-cpr-vcodex", homeStats: "Statistiekeditor",
  ...
  Object.assign(messages, {
    be: {
      navHome: "Галоўная", navStats: "Рэдактар статыстыкі", darkMode: "Цёмны рэжым", lightMode: "Светлы рэжым", homeSubtitle: "Невялікія браузерныя інструменты для CPR-vCodex. Усё працуе лакальна ў вашым браузеры.", latestFirmware: "Апошняя прашыўка: 1.6.0.1-cpr-vcodex", homeStats: "Рэдактар статыстыкі",
    ...
    kk: {
      navHome: "Басты бет", navStats: "Статистика редакторы", darkMode: "Қараңғы режим", lightMode: "Жарық режим", homeSubtitle: "CPR-vCodex үшін шағын браузер құралдары. Барлығы браузерде жергілікті орындалады.", latestFirmware: "Соңғы firmware: 1.6.0.1-cpr-vcodex", homeStats: "Статистика редакторы",
    ...
    si: {
      navHome: "Domov", navStats: "Urejevalnik statistik", darkMode: "Temni način", lightMode: "Svetli način", homeSubtitle: "Majhna brskalniška orodja za CPR-vCodex. Vse teče lokalno v brskalniku.", latestFirmware: "Najnovejši firmware: 1.6.0.1-cpr-vcodex", homeStats: "Urejevalnik statistik",
  ...
  Object.assign(messages, {
    hu: {
      navHome: "Kezdőlap", navStats: "Statisztika szerkesztő", darkMode: "Sötét mód", lightMode: "Világos mód", homeSubtitle: "Kis böngészős eszközök a CPR-vCodexhez. Minden helyben fut a böngésződben.", latestFirmware: "Legújabb firmware: 1.6.0.1-cpr-vcodex", homeStats: "Statisztika szerkesztő",
    ...
    lt: {
      navHome: "Pradžia", navStats: "Statistikos redaktorius", darkMode: "Tamsus režimas", lightMode: "Šviesus režimas", homeSubtitle: "Maži naršyklės įrankiai CPR-vCodex. Viskas veikia lokaliai jūsų naršyklėje.", latestFirmware: "Naujausia programinė įranga: 1.6.0.1-cpr-vcodex", homeStats: "Statistikos redaktorius",
    ...
    ro: {
      navHome: "Acasă", navStats: "Editor statistici", darkMode: "Mod întunecat", lightMode: "Mod luminos", homeSubtitle: "Mici unelte de browser pentru CPR-vCodex. Totul rulează local în browser.", latestFirmware: "Cel mai nou firmware: 1.6.0.1-cpr-vcodex", homeStats: "Editor statistici",
    ...
    sv: {
      navHome: "Hem", navStats: "Statistikredigerare", darkMode: "Mörkt läge", lightMode: "Ljust läge", homeSubtitle: "Små webbläsarverktyg för CPR-vCodex. Allt körs lokalt i din webbläsare.", latestFirmware: "Senaste firmware: 1.6.0.1-cpr-vcodex", homeStats: "Statistikredigerare",
    ...
    tr: {
      navHome: "Ana sayfa", navStats: "İstatistik düzenleyici", darkMode: "Karanlık mod", lightMode: "Aydınlık mod", homeSubtitle: "CPR-vCodex için küçük tarayıcı araçları. Her şey tarayıcınızda yerel çalışır.", latestFirmware: "En son firmware: 1.6.0.1-cpr-vcodex", homeStats: "İstatistik düzenleyici",
    ...
    uk: {
      navHome: "Головна", navStats: "Редактор статистики", darkMode: "Темний режим", lightMode: "Світлий режим", homeSubtitle: "Невеликі браузерні інструменти для CPR-vCodex. Усе працює локально у браузері.", latestFirmware: "Остання прошивка: 1.6.0.1-cpr-vcodex", homeStats: "Редактор статистики",
    ...
    vi: {
      navHome: "Trang chủ", navStats: "Trình sửa thống kê", darkMode: "Chế độ tối", lightMode: "Chế độ sáng", homeSubtitle: "Các công cụ trình duyệt nhỏ cho CPR-vCodex. Mọi thứ chạy cục bộ trong trình duyệt của bạn.", latestFirmware: "Firmware mới nhất: 1.6.0.1-cpr-vcodex", homeStats: "Trình sửa thống kê",
  ...
  Object.assign(messages, {
    cs: {
      navHome: "Domů", navStats: "Editor statistik", darkMode: "Tmavý režim", lightMode: "Světlý režim", homeSubtitle: "Malé nástroje v prohlížeči pro CPR-vCodex. Vše běží lokálně ve vašem prohlížeči.", latestFirmware: "Nejnovější firmware: 1.6.0.1-cpr-vcodex", homeStats: "Editor statistik",
    ...
    da: {
      navHome: "Hjem", navStats: "Statistikeditor", darkMode: "Mørk tilstand", lightMode: "Lys tilstand", homeSubtitle: "Små browserværktøjer til CPR-vCodex. Alt kører lokalt i din browser.", latestFirmware: "Nyeste firmware: 1.6.0.1-cpr-vcodex", homeStats: "Statistikeditor",
      ...
      navHome: "Etusivu", navStats: "Tilastoeditori", darkMode: "Tumma tila", lightMode: "Vaalea tila", homeSubtitle: "Pieniä selaintyökaluja CPR-vCodexille. Kaikki toimii paikallisesti selaimessasi.", latestFirmware: "Uusin firmware: 1.6.0.1-cpr-vcodex", homeStats: "Tilastoeditori",
    ...
    pl: {
      navHome: "Start", navStats: "Edytor statystyk", darkMode: "Tryb ciemny", lightMode: "Tryb jasny", homeSubtitle: "Małe narzędzia przeglądarkowe dla CPR-vCodex. Wszystko działa lokalnie w przeglądarce.", latestFirmware: "Najnowszy firmware: 1.6.0.1-cpr-vcodex", homeStats: "Edytor statystyk",
    ...
    ru: {
      navHome: "Главная", navStats: "Редактор статистики", darkMode: "Тёмный режим", lightMode: "Светлый режим", homeSubtitle: "Небольшие браузерные инструменты для CPR-vCodex. Всё работает локально в браузере.", latestFirmware: "Последняя прошивка: 1.6.0.1-cpr-vcodex", homeStats: "Редактор статистики",
