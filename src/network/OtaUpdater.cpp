...
namespace {
constexpr char firmwareManifestUrl[] = "https://boydj.github.io/cpr-vcodex/firmware/manifest.json";
constexpr char latestReleaseUrl[] = "https://api.github.com/repos/boydj/cpr-vcodex/releases/latest";
