...
void KOReaderProfileListActivity::loop() {
  ...
  // Always at least 1 (the virtual "Add Profile" row), unlike OpdsServerListActivity's
  // picker mode which can legitimately be empty -- so no need to guard on count here.
